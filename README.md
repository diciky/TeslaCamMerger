...
如果您不想安装开发环境，可以直接从 GitHub 获取已打包好的程序：

1. 前往本仓库的 **[Actions](https://github.com/diciky/TeslaCamMerger/actions)** 页面。
2. 点击最近一次成功的 **"Build Multi-Platform Apps"** 记录。
3. 在页面底部的 **Artifacts** 区域下载对应平台的压缩包：
   - `TeslaCamMerger_macOS_DMG`: 适合 Mac 用户。
   - `TeslaCamMerger_Windows`: 适合 Windows 用户。
